...
syl = syl.replace(/가/g, "ka");
syl = syl.replace(/각/g, "kak");
syl = syl.replace(/간/g, "kan");
syl = syl.replace(/갇/g, "kad");
syl = syl.replace(/갈/g, "kal");
syl = syl.replace(/갉/g, "kalk");
syl = syl.replace(/갊/g, "kalm");
syl = syl.replace(/감/g, "kam");
syl = syl.replace(/갑/g, "kap");
syl = syl.replace(/값/g, "kaps");
syl = syl.replace(/갓/g, "kas");
syl = syl.replace(/갔/g, "kass");
syl = syl.replace(/강/g, "kang");
syl = syl.replace(/갖/g, "kaj");
syl = syl.replace(/갗/g, "kach");
syl = syl.replace(/같/g, "kat");
syl = syl.replace(/갚/g, "kap");
syl = syl.replace(/갛/g, "kah");
syl = syl.replace(/개/g, "kae");
syl = syl.replace(/객/g, "kaek");
syl = syl.replace(/갠/g, "kaen");
syl = syl.replace(/갤/g, "kael");
syl = syl.replace(/갬/g, "kaem");
syl = syl.replace(/갭/g, "kaep");
syl = syl.replace(/갯/g, "kaes");
syl = syl.replace(/갰/g, "kaess");
syl = syl.replace(/갱/g, "kaeng");
syl = syl.replace(/갸/g, "kya");
syl = syl.replace(/갹/g, "kyak");
syl = syl.replace(/갼/g, "kyan");
syl = syl.replace(/걀/g, "kyal");
syl = syl.replace(/걋/g, "kyas");
syl = syl.replace(/걍/g, "kyang");
syl = syl.replace(/걔/g, "kyae");
syl = syl.replace(/걘/g, "kyaen");
syl = syl.replace(/걜/g, "kyael");
syl = syl.replace(/거/g, "keo");
syl = syl.replace(/걱/g, "keok");
syl = syl.replace(/건/g, "keon");
syl = syl.replace(/걷/g, "keot");
syl = syl.replace(/걸/g, "keol");
syl = syl.replace(/걺/g, "keolm");
syl = syl.replace(/검/g, "keom");
syl = syl.replace(/겁/g, "keop");
syl = syl.replace(/것/g, "keos");
syl = syl.replace(/겄/g, "keoss");
syl = syl.replace(/겅/g, "keong");
syl = syl.replace(/겆/g, "keoj");
syl = syl.replace(/겉/g, "keot");
syl = syl.replace(/겊/g, "keop");
syl = syl.replace(/겋/g, "keoh");
syl = syl.replace(/게/g, "ke");
syl = syl.replace(/겐/g, "ken");
syl = syl.replace(/겔/g, "kel");
syl = syl.replace(/겜/g, "kem");
syl = syl.replace(/겝/g, "kep");
syl = syl.replace(/겟/g, "kes");
syl = syl.replace(/겠/g, "kess");
syl = syl.replace(/겡/g, "keng");
syl = syl.replace(/겨/g, "kyeo");
syl = syl.replace(/격/g, "kyeok");
syl = syl.replace(/겪/g, "kyeokk");
syl = syl.replace(/견/g, "kyeon");
syl = syl.replace(/겯/g, "kyeot");
syl = syl.replace(/결/g, "kyeol");
syl = syl.replace(/겸/g, "kyeom");
syl = syl.replace(/겹/g, "kyeop");
syl = syl.replace(/겻/g, "kyeos");
syl = syl.replace(/겼/g, "kyeoss");
syl = syl.replace(/경/g, "kyeong");
syl = syl.replace(/곁/g, "kyeot");
syl = syl.replace(/계/g, "kye");
syl = syl.replace(/곈/g, "kyen");
syl = syl.replace(/곌/g, "kyel");
syl = syl.replace(/곕/g, "kyep");
syl = syl.replace(/곗/g, "kyes");
syl = syl.replace(/고/g, "ko");
syl = syl.replace(/곡/g, "kok");
syl = syl.replace(/곤/g, "kon");
syl = syl.replace(/곧/g, "kod");
syl = syl.replace(/골/g, "kol");
syl = syl.replace(/곪/g, "kolm");
syl = syl.replace(/곬/g, "kols");
syl = syl.replace(/곯/g, "kolh");
syl = syl.replace(/곰/g, "kom");
syl = syl.replace(/곱/g, "kop");
syl = syl.replace(/곳/g, "kos");
syl = syl.replace(/공/g, "kong");
syl = syl.replace(/곶/g, "koj");
syl = syl.replace(/과/g, "kwa");
syl = syl.replace(/곽/g, "kwak");
syl = syl.replace(/관/g, "kwan");
syl = syl.replace(/괄/g, "kwal");
syl = syl.replace(/괆/g, "kwalm");
syl = syl.replace(/괌/g, "kwam");
syl = syl.replace(/괍/g, "kwap");
syl = syl.replace(/괏/g, "kwas");
syl = syl.replace(/광/g, "kwang");
syl = syl.replace(/괘/g, "kwae");
syl = syl.replace(/괜/g, "kwaen");
syl = syl.replace(/괠/g, "kwael");
syl = syl.replace(/괩/g, "kwaep");
syl = syl.replace(/괬/g, "kwaess");
syl = syl.replace(/괭/g, "kwaeng");
syl = syl.replace(/괴/g, "koe");
syl = syl.replace(/괵/g, "koek");
syl = syl.replace(/괸/g, "koen");
syl = syl.replace(/괼/g, "koel");
syl = syl.replace(/굄/g, "koem");
syl = syl.replace(/굅/g, "koep");
syl = syl.replace(/굇/g, "koes");
syl = syl.replace(/굉/g, "koeng");
syl = syl.replace(/교/g, "kyo");
syl = syl.replace(/굔/g, "kyon");
syl = syl.replace(/굘/g, "kyol");
syl = syl.replace(/굡/g, "kyop");
syl = syl.replace(/굣/g, "kyos");
syl = syl.replace(/구/g, "ku");
syl = syl.replace(/국/g, "kuk");
syl = syl.replace(/군/g, "kun");
syl = syl.replace(/굳/g, "kud");
syl = syl.replace(/굴/g, "kul");
syl = syl.replace(/굵/g, "kulk");
syl = syl.replace(/굶/g, "kulm");
syl = syl.replace(/굻/g, "kulh");
syl = syl.replace(/굼/g, "kum");
syl = syl.replace(/굽/g, "kup");
syl = syl.replace(/굿/g, "kus");
syl = syl.replace(/궁/g, "kung");
syl = syl.replace(/궂/g, "kuj");
syl = syl.replace(/궈/g, "kweo");
syl = syl.replace(/궉/g, "kweok");
syl = syl.replace(/권/g, "kwen");
syl = syl.replace(/궐/g, "kwel");
syl = syl.replace(/궜/g, "kweoss");
syl = syl.replace(/궝/g, "kweong");
syl = syl.replace(/궤/g, "kwe");
syl = syl.replace(/궷/g, "kwes");
syl = syl.replace(/귀/g, "kwi");
syl = syl.replace(/귁/g, "kwik");
syl = syl.replace(/귄/g, "kwin");
syl = syl.replace(/귈/g, "kwil");
syl = syl.replace(/귐/g, "kwim");
syl = syl.replace(/귑/g, "kwip");
syl = syl.replace(/귓/g, "kwis");
syl = syl.replace(/규/g, "kyu");
syl = syl.replace(/균/g, "kyun");
syl = syl.replace(/귤/g, "kyul");
syl = syl.replace(/그/g, "keu");
syl = syl.replace(/극/g, "keuk");
syl = syl.replace(/근/g, "keun");
syl = syl.replace(/귿/g, "keud");
syl = syl.replace(/글/g, "keul");
syl = syl.replace(/긁/g, "keulk");
syl = syl.replace(/금/g, "keum");
syl = syl.replace(/급/g, "keup");
syl = syl.replace(/긋/g, "keus");
syl = syl.replace(/긍/g, "keung");
syl = syl.replace(/긔/g, "ki");
syl = syl.replace(/기/g, "ki");
syl = syl.replace(/긱/g, "kik");
syl = syl.replace(/긴/g, "kin");
syl = syl.replace(/긷/g, "kid");
syl = syl.replace(/길/g, "kil");
syl = syl.replace(/긺/g, "kilm");
syl = syl.replace(/김/g, "kim");
syl = syl.replace(/깁/g, "kip");
syl = syl.replace(/깃/g, "kis");
syl = syl.replace(/깅/g, "king");
syl = syl.replace(/깆/g, "kij");
syl = syl.replace(/깊/g, "kip");
...
syl = syl.replace(/geojinmal/g, "keojitmal");
...
syl = syl.replace(/geureokka/g, "keureolkka");
syl = syl.replace(/geokka/g, "keolkka");
...
syl = syl.replace(/gyeonkk/g, "kyeokk");
...
syl = syl.replace(/ganjireopimyeon/g, "kanjireophimyeon");
...
syl = syl.replace(/eopsjyo/g, "eopjyo");
syl = syl.replace(/eopsgetji/g, "eopgetji");
syl = syl.replace(/ttatteushan/g, "ttatteuthan");
	
syl = syl.replace(/balkeun/g, "balgeun");
syl = syl.replace(/bakge/g, "balkge");
syl = syl.replace(/pogeunan/g, "pogeunhan");
syl = syl.replace(/syung/g, "shyung");

syl = syl.replace(/geopi/g, "keobi");
syl = syl.replace(/neolpeun/g, "neolbeun");
syl = syl.replace(/malkeun/g, "malgeun");
syl = syl.replace(/jigyeo/g, "jikyeo");
syl = syl.replace(/nogo/g, "noko");
syl = syl.replace(/noji/g, "nochi");
	
syl = syl.replace(/joda/g, "jota");
syl = syl.replace(/ssahyeo/g, "ssayeo");
syl = syl.replace(/daheumyeon /g, "daeumyeon");
syl = syl.replace(/haetage/g, "aetage");
syl = syl.replace(/hamkkehhaetteon/g, "hamkkehaetteon");
syl = syl.replace(/dwhaetdamyeon/g, "dwaetdamyeon");
syl = syl.replace(/mujighaetbit/g, "mujigaetbit");
	
syl = syl.replace(/eunasu/g, "eunhasu");
syl = syl.replace(/mianae/g, "mianhae");
syl = syl.replace(/hanaana/g, "hanahana");
syl = syl.replace(/pogeuni/g, "pogeunhi");
syl = syl.replace(/jeonallae/g, "jeonhallae");
	 
syl = syl.replace(/jengong/g, "juingong");
syl = syl.replace(/imnajchum/g, "immatchum");
syl = syl.replace(/jinja/g, "jinjja");
syl = syl.replace(/beonjeum/g, "beonjjeum");
syl = syl.replace(/beonjae/g, "beonjjae");
syl = syl.replace(/akka/g, "alkka");
	
syl = syl.replace(/hikkeum/g, "hilkkeum");
syl = syl.replace(/jiweojikka/g, "jiweojilkka");
syl = syl.replace(/bukge/g, "bulkke");
syl = syl.replace(/geonilkka/g, "keonikka");
syl = syl.replace(/eosaekhanilkka/g, "eosaekhanikka");
	
syl = syl.replace(/tenilkka/g, "tenikka");
syl = syl.replace(/anilkka/g, "anikka");
syl = syl.replace(/seonggeuphae/g, "seonggeubhae");
syl = syl.replace(/jengongi/g, "juingongi");
syl = syl.replace(/gati/g, "kachi");
...
syl = syl.replace(/gathin/g, "kachin");
...
syl = syl.replace(/ttatteushae/g, "ttatteuthae");	
syl = syl.replace(/challanan/g, "challanhan");
syl = syl.replace(/doechajeul/g, "dwechajeul");
syl = syl.replace(/doeeo/g, "dweeo");
syl = syl.replace(/doegama/g, "dwegama");
syl = syl.replace(/doen/g, "dwen");
syl = syl.replace(/dwhaetgi/g, "dwaetgi");
syl = syl.replace(/georeobokka/g, "keoreobolkka");
syl = syl.replace(/geureonilkka/g, "keureonikka");
syl = syl.replace(/hwanage/g, "hwanhage");
syl = syl.replace(/noeril/g, "nweril");
syl = syl.replace(/toesaekhaebeorin/g, "twesaekhaebeorin");
...
syl = syl.replace(/alkkaweo/g, "akkaweo");
syl = syl.replace(/andoegesseo/g, "andwegesseo");
syl = syl.replace(/bonhaettago/g, "bonaettago");
syl = syl.replace(/dorigil/g, "dorikil");
syl = syl.replace(/dwhaetjana/g, "dwaetjana");
syl = syl.replace(/eopsgenne/g, "eopgenne");
syl = syl.replace(/eopseunilkka/g, "eopseunikka");
syl = syl.replace(/eopsjana/g, "eopjana");
syl = syl.replace(/gathyeoinneun/g, "kachyeoinneun");
syl = syl.replace(/gyesanaebwa/g, "kyesanhaebwa");
syl = syl.replace(/haesseunilkka/g, "haesseunikka");
syl = syl.replace(/hhaetjiman/g, "haetjiman");
syl = syl.replace(/jimjakhhaetji/g, "jimjakhaetji");
...
syl = syl.replace(/ginilkka/g, "kinikka");
...
syl = syl.replace(/areumdaunilkka/g, "areumdaunikka");
syl = syl.replace(/bhaeteo/g, "baeteo");
syl = syl.replace(/bonilkka/g, "bonikka");
syl = syl.replace(/dalkka/g, "dakka");
syl = syl.replace(/doechajeuryeo/g, "dwechajeuryeo");
syl = syl.replace(/dwhaetji/g, "dwaetji");
syl = syl.replace(/gathyeo/g, "kachyeo");
syl = syl.replace(/goeroweotji/g, "kweroweotji");
syl = syl.replace(/hhaetteon/g, "haetteon");
syl = syl.replace(/huhoe/g, "huhwe");
syl = syl.replace(/huhoehae/g, "huhwehae");
syl = syl.replace(/jigilge/g, "jikilge");
syl = syl.replace(/malhaejweotteuti/g, "malhaejweotteushi");
...
syl = syl.replace(/galkkai/g, "kakkai");
syl = syl.replace(/galkkaun/g, "kakkaun");
syl = syl.replace(/gyehoegi/g, "kyehwegi");
...
syl = syl.replace(/geumanae/g, "keumanhae");
...
syl = syl.replace(/geumanaja/g, "keumanhaja");
...
syl = syl.replace(/georeukka/g, "keoreulkka");
...
syl = syl.replace(/kakwen/g, "kagwen");
